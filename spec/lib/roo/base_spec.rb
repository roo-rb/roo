...
describe Roo::Base do
  let(:klass) do
    Class.new(Roo::Base) do
      ...
      def read_cells(sheet = default_sheet)
        ...
        @cell[sheet] = @data
        @cell_type[sheet] = @data.map { |k, v| [k, type_map.find {|type,_| v.is_a?(type) }.last ] }.to_h
  ...
  describe '#uri?' do
    it 'should return true when passed a filename starts with http(s)://' do
  ...
  it 'should return the first column as letter' do
  ...
  it 'should return the last column as letter' do
  ...
  it 'should return an enumerator with every row' do
...
EOS
  ...
  it 'should convert to csv using the separator' do
